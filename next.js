        ...
        if (regex.test(cellValue)) {
          ...
          for (let i = rowIndex; i < lastcol; i++) {
            ...
            if (goup3rule == 1) {
              ...
              const pairValueString = `Пара в ${timeif}: ${goup3rule}`;
            ...
            if (goup2rule == 1) {
              ...
              const pairValueString = `Пара в ${timeif}: ${goup2rule}`;
              const cleanedPairValue = pairValueString.replace(/[\r\n]+/g, '');
            ...
            if(cellValueT == 1){
              ...
              const pairValueTString = `Пара в ${timeifT}: ${cellValueT}`;
            ...
            if(cellValue == 1){
                ...
                const pairValueString = `Пара в ${timeif}: ${cellValue}`;
                const cleanedPairValue = pairValueString.replace(/[\r\n]+/g, '');
...
module.exports = { pairValue, pairValue2, pairValue3, pairValueT };


console.log('пара группа 1')
console.log(pairValue);

console.log('пара группа 2')
console.log(pairValue2);

console.log('пара группа 3')
